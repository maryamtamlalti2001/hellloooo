...
public class TestState extends Frame implements ActionListener{
	...
	// Handle GUI actions.
	public void actionPerformed(@SuppressWarnings("exports")
	...
	System.out.println("Before pull(): color ="+context.getState().getColor());
	context.pull();

	textArea.setBackground(context.getState().getColor());
	System.out.println("After pull(): color ="+context.getState().getColor());
